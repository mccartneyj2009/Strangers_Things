...
const Navbar = ({ user, setUser }) => {
    ...
    return (
        <header className="bg-blue-500 w-screen sticky top-0">
            ...
            >
                <div className="flex flex-row space-x-4 justify-end pr-4 h-12">
                    <Link
                        className="flex flex-row items-center justify-center rounded-lg h-10 w-20  hover:bg-blue-900 hover:text-white hover:shadow-md"
                        to="/"
                    >
                        Home
                    </Link>
